...
import military.gunbam.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
     ...
     * 카메라 전/후면 아이다 값
     */
    private int facingId = CameraCharacteristics.LENS_FACING_BACK;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facingId == facingId) {
            ...
            try {
                ...
                manager.openCamera(mCameraId, new CameraDevice.StateCallback() {
                    ...
                    public void onOpened(@NonNull CameraDevice cameraDevice) {
                        ...
                        mCameraDevice = cameraDevice;
                        createCameraPreviewSession();
                        mCameraOpenCloseLock.release(); // 세션 생성이 완료되었으므로 락 해제
                    }
